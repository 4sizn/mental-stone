          ...
          entriesAsync.when(
            ...
            data: (entries) {
              ...
              for (final e in monthEntries) {
                ...
                entryDays[day] = (entryDays[day] ?? 0) + 1;
              }

              return ListView(
                padding: EdgeInsets.fromLTRB(
                    AppSpacing.marginPage, topPad, AppSpacing.marginPage, 120),
                children: [
                  ...
                  _MonthGrid(
                      year: now.year, month: now.month, entryDays: entryDays),
                  const SizedBox(height: AppSpacing.stackLg),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('이번 달 기록', style: AppTextStyles.labelMedium),
                      Text('${monthEntries.length}개',
